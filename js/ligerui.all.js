    ...
    $.ligerui.controls.CheckBoxList.ligerExtend($.ligerui.controls.Input, {
        ...
        _setDisabled: function (value) {
            ...
            if (value) {
                ...
                $("input:checkbox", this.checkboxList).attr("disabled", true);

            } else {
                this.checkboxList.removeClass('l-checkboxlist-disabled');
                $("input:checkbox", this.checkboxList).removeAttr("disabled");
            }
        },
        _setWidth: function (value) {
        ...
        _setFields: function (fields) {
            ...
            (function () {
                ...
                $(fields).each(function (fieldIndex, field) {
                    var container = $(g.element).find("[id='" + g.id + "|" + fieldIndex + "']")/*document.getElementById(g.id + "|" + fieldIndex)*/, editor = p.editors[field.type];
                    if (!container) return;
...
(function ($) {
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        reRender: function (e) {
            var g = this, p = this.options, data;
            e = e || {};
            var rowdata = e.rowdata, column = e.column, ignoreTotal = e.ignoreTotal;
            ...
            if (column.totalSummary) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (realFixed > 0 && realFixed < fixed) {
                        sum += Math.round(value * Math.pow(10, realFixed) * Math.pow(10, fixed - realFixed));
                    } else {
                        sum += Math.round(value * fixedPow);
                    }
                }
                sum = sum / fixedPow;
...
(function ($) {
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        moveToLastTabItem: function () {
            var g = this, p = this.options, tabitem;
            var sumwidth = 0;
            $("li", g.tab.links.ul).each(function () {
                tabitem = $(this);
